# scarletkc/vexor：Skill 说明与安装

scarletkc/vexor 是 [anbeime/skill](https://github.com/anbeime/skill) 技能商店收录的官方技能，来源条目指向：[https://github.com/scarletkc/vexor](https://github.com/scarletkc/vexor)。

它在技能商店中的分类是 **开发与测试**。Vector-powered CLI for semantic file search with a Claude/Codex skill。
...
```text
帮我安装这个 Skill：https://github.com/scarletkc/vexor
...
git clone --depth 1 https://github.com/scarletkc/vexor.git ~/src/scarletkc-vexor
find ~/src/scarletkc-vexor -name SKILL.md -print
...
scarletkc/vexor 的价值在于把“Vector-powered CLI for semantic file search with a Claude/Codex skill”这类任务转成可复用的代理流程。安装时以来源链接和实际 `SKILL.md` 为准，不要把没有入口文件的目录当成已安装成功。
